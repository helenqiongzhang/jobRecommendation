...
(function() {
	...
	function init() {
		...
		//validate session to see if user is already logged in or not
		validateSession();
	}
	...
	/**
	 * A helper function that highlights an active navigation button 
	 * 
	 * @param btnId -
	...
	// only show register form, hide the rest
	...
	//encapsulate ajax helper function
