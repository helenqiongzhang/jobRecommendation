...
public class MonkeyLearnClient {
	private static final String API_KEY = "114b830190239dbd3e6f5f2cf505952b1eb59792";
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		// Use the keyword extractor, default return 10 changed to top 3
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		// Iterate the result array and convert it to List<List<String>>.
